...
const PRIORITY_CONFIG: Record<NotificationTemplate['priority'], { label: string; color: string }> = {
  ...
  P3_NORMAL: { label: 'P3 Normal', color: 'bg-sky-100 text-sky-700 hover:bg-sky-100' },
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Gérez les annonces vocales diffusées sur les écrans kiosk de votre gare
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50 dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-80">
                <TableHead className="font-semibold text-slate-600 dark:text-slate-300">Nom</TableHead>
                <TableHead className="font-semibold text-slate-600 dark:text-slate-300">Type</TableHead>
                <TableHead className="font-semibold text-slate-600 dark:text-slate-300">Priorité</TableHead>
                <TableHead className="font-semibold text-slate-600 dark:text-slate-300">Mode</TableHead>
                <TableHead className="font-semibold text-slate-600 dark:text-slate-300">Statut</TableHead>
                <TableHead className="font-semibold text-slate-600 dark:text-slate-300">Envois</TableHead>
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="flex flex-col">
                        <span className="font-medium text-slate-800 dark:text-white">{template.name}</span>
                    ...
                    <TableCell>
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#FF1D8D] focus:ring-offset-2 ${
                          template.isActive ? 'bg-[#FF1D8D]' : 'bg-muted'
                        }`}
                      >
                        <span
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <Button
                          ...
                          className="h-8 px-2 text-xs text-[#FF1D8D] hover:text-[#FF1D8D]/80 hover:bg-[#FF1D8D]/10 rounded-lg font-semibold"
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 p-4 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-sm font-semibold text-slate-700 dark:text-slate-300">Variables disponibles</h4>
        </div>
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <code
              key={v.var}
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded px-2 py-1 text-xs font-mono text-slate-700 dark:text-slate-300"
              title={v.desc}
            >
              {v.var}
            </code>

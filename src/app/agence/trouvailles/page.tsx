  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">Liste des colis livrés</p>
      </div>
        ...
        <div className="fixed top-4 right-4 z-50 animate-in slide-in-from-right duration-300">
          <div className="bg-emerald-500 text-white rounded-xl p-4 shadow-lg flex items-center gap-3 max-w-sm">
            ...
            <div className="flex-1">
              ...
              <p className="text-emerald-100 text-xs">Un colis a été marqué comme livré.</p>
            </div>
            <button
      ...
      <div className="kpi-card kpi-card-green p-6 mb-8 max-w-xs">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-white/80">Colis livrés</p>
          </div>
        </div>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50">
                ...
                <th className="text-left px-6 py-4 text-slate-500 dark:text-slate-400 font-medium text-sm hidden md:table-cell">Date</th>
                ...
                <tr>
                  <td colSpan={5} className="text-center py-12">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-slate-500 dark:text-slate-400">Aucun colis livré</p>
                      <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Les colis livrés apparaîtront ici</p>
                    </div>
                  </td>
                </tr>
              ) : (
                ...
                <div className="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-800 rounded-xl p-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      ...
                      <p className="text-slate-800 dark:text-white font-medium">{selectedBaggage.receiverName}</p>
                    </div>
